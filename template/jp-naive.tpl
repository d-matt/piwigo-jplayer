...
{combine_css id="jp_blue_monday" path="`$JPLAYER_PATH`/skin/naive/jplayer.naive.css"}
...
<div id="jp_container_1" class="jp-video jp-video-270p" style="width:{$WIDTH}; min-width:480px">
  <div class="jp-type-single">
    ...
    <div class="jp-gui">
      {* here we declare a height to verticaly center the play icon on the video frame *}
      <div class="jp-video-play" style="height:{$HEIGHT};">
